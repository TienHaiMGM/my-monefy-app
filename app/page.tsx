...
export default function DashboardPage() {
  ...
  // Tính chi tiêu luỹ kế theo ngày để trừ tổng thu nhập
  ...
  }).reverse(); // Đảo ngược để ngày mới ở trên
...
const savedPercent = budget ? (savedAmount / budget.saving_goal) * 100 : 0;
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <h1 className="text-2xl font-bold mb-4">📊 Tổng quan chi tiêu tháng {month}</h1>
